...
const char* GetVendorName(uint16_t vendorID){
    ...
    return itoa(vendorID, temp_str, 16);
}
...
const char* GetDeviceName(uint16_t vendorID, uint16_t deviceID){
    ...
    return itoa(deviceID, temp_str, 16);
}
...
const char* MassStorageControllerSubclassName(uint8_t subclassCode){
    ...
    return itoa(subclassCode, temp_str, 16);
}
...
const char* GetProgIFName(uint8_t classCode, uint8_t subclassCode, uint8_t progIF){
    ...
    return itoa(progIF, temp_str, 16);
}
...
const char* getDeviceClassName(uint8_t classCode){
    ...
    return itoa(classCode, temp_str, 16);
}